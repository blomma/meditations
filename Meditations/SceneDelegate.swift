...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo _: UISceneSession, options _: UIScene.ConnectionOptions) {
        ...
        let contentView = RootView()
            ...
            .environmentObject(Questions.shared)
        ...
        if let windowScene = scene as? UIWindowScene {
            ...
            UINavigationBar.appearance().largeTitleTextAttributes = [
                NSAttributedString.Key.font: UIFont(descriptor: descriptor2!, size: 34),
                NSAttributedString.Key.foregroundColor: UIColor(named: "ACText")!,
            ]

            UINavigationBar.appearance().titleTextAttributes = [
                NSAttributedString.Key.font: UIFont(descriptor: descriptor!, size: 17),
                NSAttributedString.Key.foregroundColor: UIColor(named: "ACText")!,
            ]
